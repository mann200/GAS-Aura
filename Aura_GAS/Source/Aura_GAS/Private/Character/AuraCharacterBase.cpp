...
AAuraCharacterBase::AAuraCharacterBase()
{
	...
	/* Passive Niagara */
	EffectAttackComponent = CreateDefaultSubobject<USceneComponent>("EffectAttachPoint");
	EffectAttackComponent->SetupAttachment(GetRootComponent());
	HaloOfProtectionNiagaraComponent = CreateDefaultSubobject<UPassiveNiagaraComponent>("HaloOfProtectionNiagaraComponent");
	HaloOfProtectionNiagaraComponent->SetupAttachment(EffectAttackComponent);
	LifeSiphonNiagaraComponent = CreateDefaultSubobject<UPassiveNiagaraComponent>("LifeSiphonNiagaraComponent");
	LifeSiphonNiagaraComponent->SetupAttachment(EffectAttackComponent);
	ManaSiphonNiagaraComponent = CreateDefaultSubobject<UPassiveNiagaraComponent>("ManaSiphonNiagaraComponent");
	ManaSiphonNiagaraComponent->SetupAttachment(EffectAttackComponent);
...
void AAuraCharacterBase::Tick(float DeltaSeconds)
{
	...
	EffectAttackComponent->SetWorldRotation(FRotator::ZeroRotator);
}
...
void AAuraCharacterBase::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	...
	DOREPLIFETIME(AAuraCharacterBase,IsBeginShocked);
}
