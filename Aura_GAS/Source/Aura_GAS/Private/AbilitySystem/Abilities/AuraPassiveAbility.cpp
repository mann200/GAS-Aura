                                          ...
                                          const FGameplayEventData* TriggerEventData)
{
	...
	{
		AuraASC->DeactivatePassiveAbility.AddUObject(this, &UAuraPassiveAbility::ReceiveDeactivated);
	}
}

void UAuraPassiveAbility::ReceiveDeactivated(const FGameplayTag& AbilityTag)
{
